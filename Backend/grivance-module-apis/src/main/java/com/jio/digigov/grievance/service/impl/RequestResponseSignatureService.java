...
import com.jio.digigov.grievance.enumeration.RecipientType;
import com.jio.digigov.grievance.exception.SignatureGenerationException;
import com.jio.digigov.grievance.exception.SignatureVerificationException;
import com.jio.digigov.grievance.repository.JwkKeyRepository;
...
import com.jio.digigov.grievance.util.SignatureJsonSerializer;
...
@Slf4j
@Service
class RequestResponseSignatureServiceImpl implements RequestResponseSignatureService {
    ...
    public boolean verifyRequest(Object payload, Map<String, String> headers)
        ...
        try {
            ...
            throw new SignatureVerificationException("Signature verification failed due to unexpected error: {} " + e.getMessage(), e);
        }
    }
