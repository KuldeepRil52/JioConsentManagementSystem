...
/**
 * JDNM (Java DigiGov Grievance Module) Error Codes.
 *
 * Format: JDNM[SERIES][UNIQUE_ID]
 * Where:
 * - JDNM = Java DigiGov Grievance Module
 * - SERIES:
...
public enum JdnmErrorCode {
    ...
    JDNM1005("JDNM1005", "Unsupported Grievance channel", HttpStatus.BAD_REQUEST),
    ...
    JDNM4011("JDNM4011", "Unauthorized Grievance access", HttpStatus.FORBIDDEN),
