...
public enum NotificationEvent {
    ...
    // PARENTAL CONSENT
    PARENTAL_CONSENT("CONSENT", "PARENTAL_CONSENT", true, true, true, false, false),
    PARENTAL_CONSENT_CREATED("CONSENT", "PARENTAL_CONSENT_CREATED", true, true, true, false, false),
