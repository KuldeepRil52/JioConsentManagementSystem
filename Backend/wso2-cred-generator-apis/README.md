...
- Kubernetes: use `deployment/deployment.yaml` and `Backend/configmap.yaml`. Replace ConfigMap placeholders (`<base64-username-password>`, `<base64-clientid-clientsecret>`, `<wso2-host>`) with real values or use Secrets and external config.
