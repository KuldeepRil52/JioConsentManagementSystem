...
# Access Swagger UI
open http://localhost:9003/v1/swagger-ui.html
```
...
|----------|-------------|----------|---------|
| `SERVER_PORT` | Service port | No | `9003` |
...
### Base URLs
- **API**: `http://localhost:9003/v1`
- **Swagger UI**: `http://localhost:9003/v1/swagger-ui.html`
- **OpenAPI JSON**: `http://localhost:9003/v1/v3/api-docs`
