...
import com.jio.partnerportal.service.ConsentService;
...
public class ConsentController {
    ...
    @Autowired
    public ConsentController(Validation validation, ConsentService consentService) {
    ...
    @PostMapping("/create")
    @Operation(
            summary = "Create consent configuration",
            description = "Creates a new consent configuration.",
            parameters = {
            ...
            requestBody = @RequestBody(
                    description = "Request body for creating a consent configuration",
                    required = true,
                    content = @Content(
                            ...
                            examples = @ExampleObject(value = """
                                    {
                                      "configurationJson": {
                                        "isDigilockerIntegration": false,
                                        "isApaarIntegration": false,
            ...
            responses = {
                    @ApiResponse(
                            responseCode = "201",
                            description = "Consent configuration created successfully",
    ...
    public ResponseEntity<ConfigCreateResponse> createConfig(@org.springframework.web.bind.annotation.RequestBody ConfigurationRequest<ConsentDetails> request, @RequestHeader Map<String, String> headers, HttpServletRequest req ) throws BodyValidationException, PartnerPortalException, JsonProcessingException {
        this.validation.validateConfigHeader(headers);
        ConsentConfig config = this.consentService.createConfig(headers, request,req);
    ...
    @Operation(
            ...
            description = "Updates an existing consent configuration by its ID.",
            parameters = {
                    @Parameter(name = "txn", description = "Transaction ID", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", format = "uuid", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef")),
                    @Parameter(name = "tenant-id", description = "Tenant ID", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", format = "uuid", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef")),
                    @Parameter(name = "x-session-token", description = "Session token for authentication", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", example = "Bearer <sessionToken>")),
                    @Parameter(name = "configId", description = "ID of the consent configuration to update", required = true, in = ParameterIn.PATH, schema = @Schema(type = "string", format = "uuid", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef"))
            },
            requestBody = @RequestBody(
                    description = "Request body for updating a consent configuration",
                    required = true,
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ConfigurationRequest.class),
            ...
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            description = "Consent configuration updated successfully",
    ...
    public ResponseEntity<ConfigUpdateResponse> updateConfig(@org.springframework.web.bind.annotation.RequestBody ConfigurationRequest<ConsentDetails> request, @RequestHeader Map<String, String> headers, @PathVariable("configId") String configId,HttpServletRequest req) throws BodyValidationException, PartnerPortalException, JsonProcessingException {
        ConsentConfig config = this.consentService.updateConfig(configId, request,req);
    ...
    @GetMapping("/search")
    @Operation(
            summary = "Search consent configurations",
            description = "Searches for consent configurations based on provided criteria like business ID, scope level, and config ID.",
            parameters = {
                    @Parameter(name = "businessId", description = "ID of the business to search for", in = ParameterIn.QUERY, example = "exampleBusinessId"),
                    @Parameter(name = "scopeLevel", description = "Scope level of the consent configuration", in = ParameterIn.QUERY, example = "TENANT", schema = @Schema(type = "string", allowableValues = {"TENANT", "BUSINESS"})),
                    @Parameter(name = "configId", description = "ID of the consent configuration", in = ParameterIn.QUERY, example = "a1b2c3d4-e5f6-7890-1234-567890abcdef"),
                    @Parameter(name = "txn", description = "Transaction ID", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", format = "uuid", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef")),
                    @Parameter(name = "tenant-id", description = "Tenant ID", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", format = "uuid", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef")),
                    @Parameter(name = "x-session-token", description = "Session token for authentication", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", example = "Bearer <sessionToken>"))
            },
    ...
    public ResponseEntity<SearchResponse<ConsentConfig>> search(@Parameter(hidden = true) @RequestParam Map<String, String> reqParams, HttpServletRequest req) throws PartnerPortalException {
        SearchResponse<ConsentConfig> response = this.consentService.search(reqParams,req);
    ...
    @GetMapping("/count")
    @Operation(
            summary = "Count consent configurations",
            description = "Returns the total count of consent configurations.",
            parameters = {
                    @Parameter(name = "txn", description = "Transaction ID", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", format = "uuid", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef")),
                    @Parameter(name = "tenant-id", description = "Tenant ID", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", format = "uuid", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef")),
                    @Parameter(name = "x-session-token", description = "Session token for authentication", required = true, in = ParameterIn.HEADER, schema = @Schema(type = "string", example = "Bearer <sessionToken>"))
    ...
    public ResponseEntity<CountResponse> count(HttpServletRequest req) {
        String activity = "Count consent configurations";

        LogUtil.logActivity(req, activity, "Success: Count consent configurations successfully");
