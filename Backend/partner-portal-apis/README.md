...
- Access to WSO2 Credential Generator Service (default: http://wso2-cred-generator-apis:9004/api/v1)
- Access to Vault Service (default: http://vault-apis:9010)
- Access to Auth Service (default: http://auth-apis:9009)
- Access to Notification Service (default: http://notification-module-apis:9005)
- Access to Audit Service (default: http://audit-module-apis:9006)
...
export WSO2_CRED_GENERATOR_APIS_URL=http://wso2-cred-generator-apis:9004/api/v1
export VAULT_APIS_URL=http://vault-apis:9010
export AUTH_APIS_URL=http://auth-apis:9009
export NOTIFICATION_MODULE_APIS_URL=http://notification-module-apis:9005
export AUDIT_MODULE_APIS_URL=http://audit-module-apis:9006
```
...
| Variable | Description | Default | Required |
|----------|-------------|---------|----------|
| `WSO2_CRED_GENERATOR_APIS_URL` | WSO2 service base URL | `http://wso2-cred-generator-apis:9004/api/v1` | No |
...
docker run -d \
  ...
  -e WSO2_CRED_GENERATOR_APIS_URL=http://wso2-cred-generator-apis:9004/api/v1 \
...
- **Maintainer:** See project maintainers
...
|-------------|-----------|---------|---------------|------|
| Local | - | localhost:27017 | wso2-cred-generator-apis:9004 | 9002 |
