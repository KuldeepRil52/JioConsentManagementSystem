...
| `NOTIFICATION_MODULE_APIS_URL` | Notification service base URL | `http://notification-module-apis:9005` |
| `AUDIT_MODULE_APIS_URL` | Audit service base URL | `http://audit-module-apis:9006` |
