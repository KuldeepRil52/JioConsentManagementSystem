 ...
 * and decryption during verification. It uses RSA-2048 encryption with OAEP padding and SHA-256.
 *
 * Security Features:
 * - RSA public-key cryptography for asymmetric encryption
 * - OAEP padding with SHA-256 for enhanced security (prevents padding oracle attacks)
