...
public class EventMessage {
    ...
    /**
     * Recipient type for the notification (DATA_PRINCIPAL or DATA_PROTECTION_OFFICER).
     * Used for filtering templates based on recipient role.
     */
    private String recipientType;

    /**
     * JWT token containing event payload for DPO notifications.
     * Used for template resolution when recipientType is DATA_PROTECTION_OFFICER.
     */
