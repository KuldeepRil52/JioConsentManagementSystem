...
public class MasterListConfigLoader {
    ...
    public MasterListConfigLoader(
            MultiTenantMongoConfig mongoConfig,
            ObjectMapper objectMapper,
            @Lazy TenantMasterListConfigService tenantMasterListConfigService,
            CacheService<MasterListConfig> cacheService) {
        this.mongoConfig = mongoConfig;
        this.objectMapper = objectMapper;
        this.tenantMasterListConfigService = tenantMasterListConfigService;
