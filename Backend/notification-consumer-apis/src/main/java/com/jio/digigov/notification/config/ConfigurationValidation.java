...
public class ConfigurationValidation implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        if (validationErrors.isEmpty()) {
            ...
            log.info("Consumer application is ready to process messages on port: {}", serverPort);
    ...
    private void validateKafkaConfiguration(List<String> errors) {
        ...
        if (consumerGroupId == null || consumerGroupId.trim().isEmpty()) {
            errors.add("Kafka consumer group ID not configured (spring.kafka.consumer.group-id)");
        }
        ...
        if (errors.isEmpty()) {
            log.info("✅ Kafka consumer configuration validated");
        }
    }
