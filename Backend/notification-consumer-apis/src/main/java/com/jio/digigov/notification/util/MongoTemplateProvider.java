...
public class MongoTemplateProvider {
     ...
     *
     * @param defaultMongoTemplate Default MongoTemplate
     * @param sharedMongoTemplate Shared database MongoTemplate (for system notifications)
     */
     ...
     *
     * Special handling for system-wide notifications:
     * - tenantId="SYSTEM" → routes to shared database (tenant_db_shared)
     * - Other tenants → routes to tenant-specific database (tenant_db_{tenantId})
     *
     * @param tenantId The tenant identifier
     * @return MongoTemplate instance for the tenant
