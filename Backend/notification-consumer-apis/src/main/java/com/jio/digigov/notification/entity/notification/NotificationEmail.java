...
public class NotificationEmail extends BaseEntity {
    ...
    /**
     * Event Type for the notification event.
     */
    @Field("eventType")
    ...
    /**
     * Type of recipient for the email notification.
     * Determines the template category and processing rules.
     * Values: "DATA_PRINCIPAL", "DATA_PROTECTION_OFFICER"
     */
    @Field("recipientType")
     ...
     * For DATA_PRINCIPAL: email address (same as primary 'to' address)
     * For DATA_PROTECTION_OFFICER: identifier from JWT or business config
     */
    @Field("recipientId")
