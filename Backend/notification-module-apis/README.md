...
**Documentation:** See your internal wiki for project documentation.
...
```bash
# Check health
curl http://localhost:9005/notification/actuator/health

# Access Swagger UI
open http://localhost:9005/notification/swagger-ui.html
```
...
|----------|-------------|---------|----------|
| `SERVER_PORT` | HTTP server port | `9005` | No |
...
| Variable | Description | Default | Required |
|----------|-------------|---------|----------|
| `DIGIGOV_BASE_URL` | DigiGov Partner Portal base URL | `http://partner-portal-apis:9002/partnerportal` | Yes |
...
| `SYSTEM_EMAIL_REPLYTO` | System email reply-to | `Jio.ConsentSupport@ril.com` | No |
...
```
http://localhost:9005/notification
```
...
**Example Request:**
```bash
curl -X POST http://localhost:9005/notification/v1/events/trigger \
...
- **Swagger UI:** http://localhost:9005/notification/swagger-ui.html
- **OpenAPI JSON:** http://localhost:9005/notification/v3/api-docs
- **OpenAPI YAML:** http://localhost:9005/notification/v3/api-docs.yaml
...
# Access service
kubectl port-forward service/notification-module 9005:9005 -n dpdp-cms
```
...
| SIT | dpdp-cms-sit | ${KAFKA_BOOTSTRAP_SERVERS} | sit-mongo-cluster | SIT Portal |
| ST | dpdp-cms-st | ${KAFKA_BOOTSTRAP_SERVERS} | st-mongo-cluster | ST Portal |
| Production | dpdp-cms | ${KAFKA_BOOTSTRAP_SERVERS} | prod-mongo-cluster | Prod Portal |
...
curl http://localhost:9005/notification/actuator/health?details=true

# Readiness probe
curl http://localhost:9005/notification/actuator/health/readiness

# Liveness probe
curl http://localhost:9005/notification/actuator/health/liveness
```
...
curl http://localhost:9005/notification/actuator/prometheus
```
...
```bash
# Application info
curl http://localhost:9005/notification/actuator/info
