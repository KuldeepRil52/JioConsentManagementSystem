...
public class RestTemplateConfig {
    ...
    public RestTemplate restTemplate(NotificationConfig config) {
        // Validate DigiGov configuration (RestTemplate only supports DigiGov)
        if (config.getProviderType() != ProviderType.DIGIGOV || config.getConfigurationJson() == null) {
    ...
    private RestTemplate createRestTemplateWithMutualSSL(NotificationConfig config) {
        ...
        if (details.getMutualSSL() != null && details.getMutualSSL() && details.getMutualCertificate() != null
            ...
            try {
                ...
                char[] password = (details.getCertificatePassword() != null && !details.getCertificatePassword().isEmpty())
