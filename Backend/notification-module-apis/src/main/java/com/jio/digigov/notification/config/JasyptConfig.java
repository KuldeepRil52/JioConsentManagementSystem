 ...
 * Provides AES-256 encryption for SMTP passwords and other sensitive fields.
 *
 ...
 * <ul>
 *   <li>Never commit the encryption password to version control</li>
...
public class JasyptConfig {
    ...
    @Value("${jasypt.encryptor.password:#{environment.JASYPT_ENCRYPTOR_PASSWORD}}")
