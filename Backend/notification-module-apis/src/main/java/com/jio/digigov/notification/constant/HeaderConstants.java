...
public final class HeaderConstants {
    ...
    // ========================================
    // Request Signature Verification Headers
    // ========================================

    /**
     * Header for tenant ID in signature verification context.
     * Used specifically for request/response signature verification.
     * Format: lowercase with hyphen (tenant-id)
     */
    public static final String TENANT_ID = "tenant-id";

    /**
     * Header for business ID in signature verification context.
     * Used specifically for DATA_FIDUCIARY signature verification.
     * Format: lowercase with hyphen (business-id)
     */
    public static final String BUSINESS_ID = "business-id";

    /**
     * Header for JWS (JSON Web Signature) signature.
     * Contains the detached JWT signature for request/response verification.
     * Format: header..signature (payload transmitted separately)
     */
    public static final String X_JWS_SIGNATURE = "x-jws-signature";

    /**
     * Header for requestor type specification.
     * Identifies if the requestor is DATA_FIDUCIARY or DATA_PROCESSOR.
     * Used to determine which certificate to use for signature verification.
     */
    public static final String REQUESTOR_TYPE = "requestor-type";

    /**
     * Header for data processor ID in signature verification context.
     * Required when requestor-type is DATA_PROCESSOR.
     * Used to fetch the data processor's certificate for signature verification.
     */
    public static final String DATA_PROCESSOR_ID = "data-processor-id";
    ...
    /**
     * Basic authentication prefix for username:password credentials.
     */
